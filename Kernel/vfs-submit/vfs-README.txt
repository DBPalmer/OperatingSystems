...
(B) vfstest: 42 out of 42 pts
    What is your kshell command to invoke vfstest_main(): vfs

(C.1) faber_fs_thread_test (6 out of 6 pts)
    What is your kshell command to invoke faber_fs_thread_test(): thrtest
(C.2) faber_directory_test (4 out of 4 pts)
    What is your kshell command to invoke faber_directory_test(): dirtest
...
1)  Names and USC e-mail addresses of team members: Lucas Palmer, dbpalmer@usc.edu
